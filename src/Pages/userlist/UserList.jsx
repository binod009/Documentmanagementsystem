			...
			<div className='userlist'>
				...
				<div className='list-container'>
					...
					<div style={{ height: 580 }}>
						<DataGrid rows={this.state.userdata} columns={this.columns} rowsPerPageOptions={[5]} checkboxSelection disableSelectionOnClick sortingMode='client' loading={this.state.loading} />
					</div>
				</div>
			</div>
		);
